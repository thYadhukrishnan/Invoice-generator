            ...
            <div class="row py-3">
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="invoiceCode" value="{{$invCode}}" class="form-control" id="invoiceCode" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group row mt-5">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="invoiceNotes" id="invoiceNotes" rows="3" required></textarea>
                        </div>
                      </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input type="date" id="invoiceDate" name="invoiceDate" class="form-control" aria-describedby="basic-addon1" required>
                            </div>
                        </div>
                      </div>
            ...
            <div class="row py-3">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="invoiceAmount" class="form-control numberOnly" id="invoiceAmount" required readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-8">
                          <input type="checkbox" name="enablevat" class="form-check-input" id="enablevat">
                ...
                <div class="col-sm-6">
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="totalVat" class="form-control" id="totalVat" readonly>
                        </div>
                      </div>
                </div>
            </div>
